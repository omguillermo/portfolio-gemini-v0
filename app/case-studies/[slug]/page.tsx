      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 pt-20 md:pt-24 pb-8 border-b border-border/10">
        ...
        <div className="mb-4 flex flex-wrap gap-2">
          {project.tag.split(/[,•]/).map((t) => (
            <span key={t.trim()} className="inline-flex items-center px-2.5 py-0.5 rounded-md text-mono font-mono text-xxs uppercase tracking-wider text-brand bg-brand/5 border border-brand/20">
              {t.trim()}
            </span>
          ))}
        </div>
